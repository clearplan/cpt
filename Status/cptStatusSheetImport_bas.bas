...
Sub cptStatusSheetImport2(ByRef myStatusSheetImport_frm As cptStatusSheetImport_frm)
  'objects
  Dim oInspector As Outlook.Inspector
  Dim oOutlook As Outlook.Application
  Dim oMailItem As Outlook.MailItem
  ...
  'clear out tasks
  Dim strAS As String
  strAS = FieldConstantToFieldName(cptGetSetting("StatusSheetImport", "cboAS"))
  Dim strAF As String
  strAF = FieldConstantToFieldName(cptGetSetting("StatusSheetImport", "cboAF"))
  Dim strNS As String
  strNS = FieldConstantToFieldName(cptGetSetting("StatusSheetImport", "cboFS"))
  Dim strNF As String
  strNF = FieldConstantToFieldName(cptGetSetting("StatusSheetImport", "cboFF"))
  strEVP = FieldConstantToFieldName(cptGetSetting("StatusSheetImport", "cboEVP"))
  Dim strETC As String
  strETC = FieldConstantToFieldName(cptGetSetting("StatusSheetImport", "cboETC"))
...
exit_here:
  ...
  Exit Sub
err_here:
  Call cptHandleErr("cptStatusSheetImport_bas", "cptStatusSheetImport2", Err, Erl)
  Resume exit_here
End Sub
